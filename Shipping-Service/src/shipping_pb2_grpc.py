...
class ShippingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TrackShippment = channel.unary_unary(
                '/shipping.Shipping/TrackShippment',
                request_serializer=shipping__pb2.ShipmentTrackRequest.SerializeToString,
                response_deserializer=shipping__pb2.ShipmentUpdate.FromString,
                )
...
class ShippingServicer(object):
    ...
    def CalculateShippingCostNoCourier(self, request, context):
        """calculates teh cost of a shipment for no particular courier
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ShippingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TrackShippment': grpc.unary_unary_rpc_method_handler(
                    servicer.TrackShippment,
                    request_deserializer=shipping__pb2.ShipmentTrackRequest.FromString,
                    response_serializer=shipping__pb2.ShipmentUpdate.SerializeToString,
            ),
...
class Shipping(object):
    ...
    def TrackShippment(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shipping.Shipping/TrackShippment',
            shipping__pb2.ShipmentTrackRequest.SerializeToString,
            shipping__pb2.ShipmentUpdate.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
