...
class Address(_message.Message):
    __slots__ = ["state", "city", "zip", "street", "country"]
    ...
    street: str
    country: str
    def __init__(self, state: _Optional[str] = ..., city: _Optional[str] = ..., zip: _Optional[str] = ..., street: _Optional[str] = ..., country: _Optional[str] = ...) -> None: ...

class Item(_message.Message):
    __slots__ = ["item_id", "item_name", "quantity"]
    ...
    item_name: str
    quantity: int
    def __init__(self, item_id: _Optional[str] = ..., item_name: _Optional[str] = ..., quantity: _Optional[int] = ...) -> None: ...
...
class Shipment(_message.Message):
    __slots__ = ["shipment_id", "user_id", "courier", "updates", "found", "delivered", "last", "package"]
    SHIPMENT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    last: ShipmentUpdate
    package: Package
    def __init__(self, shipment_id: _Optional[str] = ..., user_id: _Optional[str] = ..., courier: _Optional[str] = ..., updates: _Optional[_Iterable[_Union[ShipmentUpdate, _Mapping]]] = ..., found: bool = ..., delivered: bool = ..., last: _Optional[_Union[ShipmentUpdate, _Mapping]] = ..., package: _Optional[_Union[Package, _Mapping]] = ...) -> None: ...

class ShippingRequest(_message.Message):
    __slots__ = ["courier", "user_id", "package", "source", "destination"]
    COURIER_FIELD_NUMBER: _ClassVar[int]
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    PACKAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    source: Address
    destination: Address
    def __init__(self, courier: _Optional[str] = ..., user_id: _Optional[str] = ..., package: _Optional[_Union[Package, _Mapping]] = ..., source: _Optional[_Union[Address, _Mapping]] = ..., destination: _Optional[_Union[Address, _Mapping]] = ...) -> None: ...
